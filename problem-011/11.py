#Progject Euler - Problem 11
#Zedwarth
#In the 220 grid below, four numbers along a diagonal line have been marked in red.
...
#What is the greatest product of four adjacent numbers in any direction (up, down, left, right, or diagonally) in the 220 grid?
...
for y in range (20): #horazontal
    for x in range (17):
        ...
        for z in range (1,4):
            ...
            if p > gp:
                gp = p
for y in range (17): #diagonally, falling right
    for x in range (17):
        p = ls [y] [x]
        for z in range (1,4):
            p = p * (ls [y+z] [x + z])
            if p > gp:
                gp = p
for y in range (17): #diagonally, falling left
    for x in range (3,20):
        p = ls [y] [x]
        for z in range (1,4):
            p = p * (ls [y+z] [x -z])
